...
#define LCD_SCL_PIN  PTE6  
#define LCD_SDA_PIN  PTC16
#define LCD_RST_PIN  PTC17 
#define LCD_DC_PIN   PTE0 
...
0x0C,0xCC,0xCC,0x0C,0xDE,0xDE,0x0C,0xCC,0xDE,0x9E,0x8C,0x8C,0x8C,0x00,
0xC0,0xFB,0xFB,0xC8,0xFB,0xFB,0xCB,0xF9,0xF8,0xC9,0xFB,0xFA,0xC0,0xC0,/*"蓝",0*/


0x38,0xB8,0x98,0x98,0x98,0x9A,0xDE,0xDC,0x98,0x98,0x98,0x98,0xB8,0x38,
0x00,0xFF,0xFF,0x69,0x69,0x69,0x7F,0x7F,0x69,0x69,0x69,0xFF,0xFF,0x00,/*"宙",0*/


0x00,0xF8,0xF8,0x98,0x98,0xFE,0xFE,0x98,0x98,0x98,0xF8,0xF8,0x00,0x00,
0x00,0x1F,0x1F,0x0C,0x0C,0x7F,0xFF,0xCC,0xCC,0xCC,0xCF,0xCF,0xF0,0x70,/*"电",0*/

0x80,0x86,0x86,0x86,0x86,0x86,0xE6,0xE6,0xB6,0x9E,0x8E,0x86,0x80,0x80,
0x01,0x01,0x01,0x01,0x41,0xC1,0xFF,0x7F,0x01,0x01,0x01,0x01,0x01,0x01,/*"子",0*/
...
void LCD_Init(void)        
{
  ...
  gpio_init  (LCD_SCL_PIN, GPO, 0);
  gpio_init  (LCD_SDA_PIN, GPO, 0);
  gpio_init  (LCD_RST_PIN, GPO, 0);
  gpio_init  (LCD_DC_PIN, GPO, 0);
...
void LCD_Draw_One_Row(unsigned char  x,unsigned char  y,char row)
{
    LCD_Set_Pos(x,y);
    LCD_WrDat(row);
}
...
void Dis_Num(unsigned char x, unsigned char y, unsigned int num,unsigned char N)
{
//  byte line;
  byte j=0;
  byte n[6]={0};
