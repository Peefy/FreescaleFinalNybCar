...
#define SECTOR_NUM_AD       (FLASH_SECTOR_NUM-1)         //Flash扇区尽量用最后面的扇区，确保安全
#define SECTOR_NUM_SERVO    (FLASH_SECTOR_NUM-2)         //Flash扇区尽量用最后面的扇区，确保安全
#define SECTOR_NUM_MPU      (FLASH_SECTOR_NUM-3)         //Flash扇区尽量用最后面的扇区，确保安全  
#define SECTOR_NUM_ShuiPing (FLASH_SECTOR_NUM-4)         //Flash扇区尽量用最后面的扇区，确保安全 
