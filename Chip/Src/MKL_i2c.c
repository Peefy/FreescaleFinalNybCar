...
char My_i2cwrite(unsigned char slave_addr, unsigned char reg_addr,\
      unsigned char length, unsigned char const *data)
{
    i2c_write_reg(I2C0,slave_addr,reg_addr,*data);
    return 0;
}

char My_i2cread(unsigned char slave_addr, unsigned char reg_addr,\
       unsigned char length, unsigned char *data)
{   
    *data=i2c_read_reg(I2C0,slave_addr,reg_addr);
    return 0;
}
