...
void ov7725_eagle_port_init()
{
    ...
    dma_portx2buff_init(CAMERA_DMA_CH, (void *)&PTE_B2_IN, (void *)ov7725_eagle_img_buff, PTA7, DMA_BYTE1, CAMERA_DMA_NUM);
    ...
    port_init(PTA6, ALT1 | IRQ_RISING  | PULLDOWN | PF);     //场中断，上拉，上降沿触发中断，带滤波
...
void ov7725_eagle_vsync(void)
{
    ...
    if(ov7725_eagle_img_flag == IMG_START)                   //需要开始采集图像
    {
        ...
        dma_repeat(CAMERA_DMA_CH, (void *)&PTE_B2_IN, (void *)ov7725_eagle_img_buff,CAMERA_DMA_NUM);
