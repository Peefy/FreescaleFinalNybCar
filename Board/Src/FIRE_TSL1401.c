...
#if 0             //宏条件编译选择不同的信号类型
ADCn_Ch_e   tsl1401_ch[] = {ADC0_SE5a,     ADC0_SE6a,    ADC0_SE4a};       //CCD所用的 ADC通道(原始信号)
#else
ADCn_Ch_e   tsl1401_ch[] = {ADC0_SE1,      ADC0_SE2,     ADC0_SE0};       //CCD所用的 ADC通道(放大信号)
#endif
