...
#else
    sendbuf[COM_LEN]   =  (uint8)var_num;
    sendbuf[COM_LEN+1] =  (uint8)(var_num>>8);
    sendbuf[COM_LEN+2] =  (uint8)(var_num>>16);
    sendbuf[COM_LEN+3] =  (uint8)(var_num>>24);

    sendbuf[COM_LEN+4]   =  (uint8)temp;
    sendbuf[COM_LEN+5] =  (uint8)(temp>>8);
    sendbuf[COM_LEN+6] =  (uint8)(temp>>16);
    sendbuf[COM_LEN+7] =  (uint8)(temp>>24);
