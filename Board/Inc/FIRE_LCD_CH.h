#ifndef _FIRE_LCD_CH_H_
#define _FIRE_LCD_CH_H_
...
extern void LCD_FChar_CH (Site_t site,const uint8 *str,uint16 Color,uint16 bkColor);
extern void LCD_FStr_CH (Site_t site,const uint8 *str,uint16 num,uint16 Color,uint16 bkColor);
